<article <?php hybrid_attr( 'post' ); ?>>
  ...
  <?php if ( is_attachment() ) : // If viewing a single attachment ?>
    ...
    <header class="entry-header">
      ...
      <div class="entry-meta">
        <span class="image-sizes"><?php printf( __( 'Sizes: %s', 'taylor' ), hybrid_get_image_size_links() ); ?></span>  
      </div><!-- .entry-meta -->
  ...
  <?php else : // If not viewing a single attachment ?>
    ...
    <?php get_the_image( array( 'size' => 'taylor-full', 'order' => array( 'featured', 'attachment' ) ) ); ?>
...
<?php if ( is_attachment() ) : // If view a single attachment ?>

  <div class="attachment-meta">

    <div class="media-info image-info">

      <h3 class="attachment-meta-title"><?php _e( 'Image Info', 'taylor' ); ?></h3>

      <?php hyrbrid_media_meta(); ?>
    ...
    <?php if ( !empty( $gallery ) ) : // Check if the gallery is not empty ?>
      ...
      <div class="image-gallery">
        <h3 class="attachment-meta-title"><?php _e( 'Gallery', 'taylor' ); ?></h3>
        <?php echo $gallery; ?>
      </div>

    <?php endif; // End gallery check ?>

  </div><!-- .attachment-media -->
